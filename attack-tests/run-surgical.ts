#!/usr/bin/env npx tsx
/**
 * Run surgical single-clause substitution test on GPT-5.2 and Claude Sonnet 4.6.
 * Tests whether a SINGLE substituted clause is detected or silently error-corrected.
 */
...
const variant = {
  name: 'consulting-geneva-surgical',
  file: join(__dirname, 'fixtures', 'consulting-geneva-surgical.txt'),
};
